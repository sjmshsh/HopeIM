...
import (
	...
	"github.com/sjmshsh/HopeIM/services/server/service"
	"github.com/sjmshsh/HopeIM/wire/pkt"
	"github.com/sjmshsh/HopeIM/wire/rpc"
)
...
func (h *GroupHandler) DoCreate(ctx HopeIM.Context) {
...
func (h *GroupHandler) DoJoin(ctx HopeIM.Context) {
...
func (h *GroupHandler) DoQuit(ctx HopeIM.Context) {
...
func (h *GroupHandler) DoDetail(ctx HopeIM.Context) {
