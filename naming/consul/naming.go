...
type Watch struct {
	Service   string
	Callback  func([]HopeIM.ServiceRegistration)
	WaitIndex uint64
	Quit      chan struct{}
}
...
func (n *Naming) Find(name string, tags ...string) ([]HopeIM.ServiceRegistration, error) {
...
func (n *Naming) load(name string, waitIndex uint64, tags ...string) ([]HopeIM.ServiceRegistration, *api.QueryMeta, error) {
	...
	services := make([]HopeIM.ServiceRegistration, len(catalogServices))
...
func (n *Naming) Register(s HopeIM.ServiceRegistration) error {
...
func (n *Naming) Subscribe(serviceName string, callback func([]HopeIM.ServiceRegistration)) error {
	n.Lock()
	defer n.Unlock()
...
func (n *Naming) watch(wh *Watch) {
	...
	var doWatch = func(service string, callback func([]HopeIM.ServiceRegistration)) {
